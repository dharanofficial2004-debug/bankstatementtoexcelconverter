...
const defaultSteps: StepItem[] = [
  {
    ...
    title: "Upload PDF",
    description:
      "Drop a PDF statement and let the parser identify the bank, dates, debits, credits, and balances automatically.",
  ...
  },
  {
    ...
    title: "Review & Edit",
    description:
      "Inspect the live spreadsheet preview, correct any OCR issues, and keep the data structured for Excel or CSV export.",
  ...
  },
  {
    ...
    title: "Export",
    description:
      "Download a clean workbook in one click and use it for taxes, bookkeeping, reconciliations, or QuickBooks import.",
